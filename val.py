...
if menu == "1. 스트리머별 종합 스탯":
    ...
    if not streamer_options:
        ...
        selected_streamer = st.selectbox("스트리머를 선택하세요", streamer_options, key="streamer_map_agent_6")
        subset = df[df["스트리머 이름"] == selected_streamer]
        ...
        if not map_options:
            ...
            selected_map = st.selectbox("맵을 선택하세요", map_options, key="map_by_streamer_6")
